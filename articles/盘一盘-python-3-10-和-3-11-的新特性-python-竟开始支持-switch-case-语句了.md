...
就在今天（6/10/2021），Python 官方发布了 `Python 3.10.0` 正式版本和 `Python 3.11.0a1` alpha 测试版。我翻阅了数万字的 Python 文档和 PEP，将精华浓缩成了这篇文章。

大家好，我是披着狼皮的羊。今天将向大家介绍介绍 Python 3.10 和 Python 3.11 中的新特性。
